        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-file-invoice-dollar me-2"></i> Monitoring Saldo Minus Perkara (Real-time Table)</h5>
                    <span class="badge bg-white text-danger px-3 py-2 rounded-pill">{{ count($dataPerkara) }} Perkara</span>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle text-center" id="tableSaldo">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td class="fw-bold text-uppercase">{{ $item->satker }}</td>
