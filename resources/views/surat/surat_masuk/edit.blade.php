                            ...
                            <div class="col-md-4 border-right-dashed px-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="asal_surat" class="form-control modern-input @error('asal_surat') is-invalid @enderror" required>
                                        ...
                                        <option value="Pengadilan Agama Direktorat Jenderal Badan Peradilan Agama" {{ old('asal_surat', $surat->asal_surat) == 'Pengadilan Agama Direktorat Jenderal Badan Peradilan Agama' ? 'selected' : '' }}>Pengadilan Agama Direktorat Jenderal Badan Peradilan Agama</option>
                                        ...
                                        <option value="Pengadilan Agama Instansi Lain" {{ old('asal_surat', $surat->asal_surat) == 'Pengadilan Agama Instansi Lain' ? 'selected' : '' }}>Pengadilan Agama Instansi Lain</option>
                                        ...
                                        <option value="Pengadilan Agama Lain-lain" {{ old('asal_surat', $surat->asal_surat) == 'Pengadilan Agama Lain-lain' ? 'selected' : '' }}>Pengadilan Agama Lain-lain</option>
                                        <option value="Pengadilan Agama Mahkamah Agung Republik Indonesia" {{ old('asal_surat', $surat->asal_surat) == 'Pengadilan Agama Mahkamah Agung Republik Indonesia' ? 'selected' : '' }}>Pengadilan Agama Mahkamah Agung Republik Indonesia</option>
                                        ...
                                        <option value="Pengadilan Agama Prinsipal" {{ old('asal_surat', $surat->asal_surat) == 'Pengadilan Agama Prinsipal' ? 'selected' : '' }}>Pengadilan Agama Prinsipal</option>
