    ...
    <div class="card modern-card border-0 shadow-lg">
        <div class="card-header header-gradient-siwas py-3 d-flex justify-content-between align-items-center border-0">
            <h5 class="m-0 font-weight-bold text-white tracking-wide">
                <i class="fas fa-plus-circle me-2 opacity-75"></i> Input Data Pengaduan (SIWAS)
            </h5>
        ...
        <div class="card-body p-4 p-md-5">
            <form action="{{ route('pengaduan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 border-end">
                        ...
                        <div class="bg-soft-light p-4 rounded-lg border-soft mb-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="tgl_terima_pgd" class="form-control modern-input @error('tgl_terima_pgd') is-invalid @enderror" value="{{ old('tgl_terima_pgd', date('Y-m-d')) }}" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="pelapor" class="form-control modern-input @error('pelapor') is-invalid @enderror" value="{{ old('pelapor') }}" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="terlapor" class="form-select modern-input @error('terlapor') is-invalid @enderror">
                                    <option value="">-- Pilih Satker Terlapor --</option>
                                    ...
                                    <option value="{{ $satker }}" {{ old('terlapor') == $satker ? 'selected' : '' }}>{{ $satker }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="uraian_pgd" class="form-control modern-input @error('uraian_pgd') is-invalid @enderror" rows="3">{{ old('uraian_pgd') }}</textarea>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select name="ditangani_oleh" class="form-select modern-input">
                                    ...
                                    <option value="Badan Pengawas MARI" {{ old('ditangani_oleh') == 'Badan Pengawas MARI' ? 'selected' : '' }}>Badan Pengawas MARI</option>
                                    <option value="Pengadilan Tingkat Banding" {{ old('ditangani_oleh') == 'Pengadilan Tingkat Banding' ? 'selected' : '' }}>Pengadilan Tingkat Banding</option>
                                    <option value="Pengadilan Tingkat Pertama" {{ old('ditangani_oleh') == 'Pengadilan Tingkat Pertama' ? 'selected' : '' }}>Pengadilan Tingkat Pertama</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-soft-light p-4 rounded-lg border-soft mb-4">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="dis_pm_hk" class="form-control modern-input shadow-xs" value="{{ old('dis_pm_hk') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="text-xxs font-weight-bold text-muted text-uppercase mb-1">Disposisi Ketua</label>
                                    <input type="date" name="dis_kpta" class="form-control modern-input shadow-xs" value="{{ old('dis_kpta') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="text-xxs font-weight-bold text-muted text-uppercase mb-1">Disposisi Wakil</label>
                                    <input type="date" name="dis_wkpta" class="form-control modern-input shadow-xs" value="{{ old('dis_wkpta') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="text-xxs font-weight-bold text-muted text-uppercase mb-1">Disposisi Hatiwasda</label>
                                    <input type="date" name="dis_hatiwasda" class="form-control modern-input shadow-xs" value="{{ old('dis_hatiwasda') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="status_pgd" class="form-select modern-input shadow-xs">
                                    ...
                                    <option value="{{ $st }}" {{ old('status_pgd') == $st ? 'selected' : '' }}>{{ $st }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select name="status_berkas" class="form-select modern-input shadow-xs">
                                    ...
                                    <option value="{{ $sb }}" {{ old('status_berkas') == $sb ? 'selected' : '' }}>{{ $sb }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>

                        <h6 class="text-success fw-bold mb-3 small"><i class="fas fa-file-upload me-2"></i>Upload Dokumen</h6>
                        <div class="row g-2">
                            <div class="col-md-6">
                                <label class="text-xxs font-weight-bold text-muted mb-1">Surat Pengaduan (PDF)</label>
                                <input type="file" name="surat_pgd" class="form-control form-control-sm">
                            </div>
                            <div class="col-md-6">
                                <label class="text-xxs font-weight-bold text-muted mb-1">Lampiran / LHP (PDF)</label>
                ...
                <div class="text-center mt-5 pt-4 border-top">
                    <button type="reset" class="btn btn-light rounded-pill px-5 fw-bold text-muted shadow-sm me-2">Reset</button>
                    <button type="submit" class="btn btn-danger rounded-pill px-5 fw-bold shadow-lg hover-elevate">
                        <i class="fas fa-save me-2"></i>Simpan Data Pengaduan
                    </button>
                </div>
            </form>
        </div>
